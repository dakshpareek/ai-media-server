...
export class VPNManager {
    ...
    manualDisconnect = false; // Track if user manually disconnected
    DISCONNECT_DELAY = 10 * 60 * 1000; // 10 minutes
    CONNECTION_TIMEOUT = 30000; // 30 seconds
    CONTAINER_NAME = 'nordvpn_official'; // Correct container name
    constructor() {
     ...
     */
    async connectVPN(preferredCity = 'australia') {
        try {
